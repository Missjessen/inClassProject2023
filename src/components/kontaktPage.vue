<template>
  ...
  <section class="mb-32">
    <div
      class="relative h-[200px] overflow-hidden bg-cover bg-[50%] bg-no-repeat" :image="'@/assets/images/me-bg.jpg'">
    </div>
      ...
      <div
        ...
        <div class="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
          <div class="mx-auto mb-12 text-center lg:mb-0">
            ...
            <h6 class="font-medium">Denmark</h6>
          </div>
          <div class="mx-auto mb-12 text-center lg:mb-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
              stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-primary dark:text-primary-400">
            ...
            <h6 class="font-medium">Esbjerg 6700</h6>
          </div>
          <div class="mx-auto mb-6 text-center md:mb-0">
            ...
            <h6 class="font-medium">+45 31125132</h6>
          </div>
          <div class="mx-auto text-center">
            <img class="mail" src="@/assets/images/mail.png" alt="">
            <h6 class="font-medium">nsj@pc.dk</h6>
